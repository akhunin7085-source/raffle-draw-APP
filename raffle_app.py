...
def main():
    ...
    if st.session_state.draw_history:
        ...
        # เนื่องจาก Streamlit รันโลคอล เราจะสร้าง QR Code ที่มีข้อความบอกผู้ใช้ให้เปิดหน้า Summary/History
        # หากคุณ Deploy ออนไลน์ URL นี้จะเปลี่ยนไปเป็น URL จริง
        summary_text = "สแกนเพื่อเข้าสู่หน้าสรุปผลรางวัลทั้งหมด (เปิดในบราวเซอร์)"
        
        # สร้าง QR Code 
        qr_base64_summary = create_qrcode_base64(summary_text)
