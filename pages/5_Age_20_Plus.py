...
# ----------------------------------------------------
GROUP_NAME = "อายุงาน 20 ปีขึ้นไป" 
...
def main():
    ...
    st.markdown("""
        ...
        .card-prize { color: #ffeb3b; font-size: 1.8em; font-weight: bold; margin-bottom: 10px; display: block; }
        .card-name { color: #4beaff; font-size: 1.7em; font-weight: bold; }
